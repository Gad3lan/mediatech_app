...
import 'package:mediatech_app/modules/screens/editRessourcesGenresScreen.dart';
import 'package:mediatech_app/modules/screens/editRessourcesTypesScreen.dart';
import 'package:mediatech_app/modules/screens/editRoleScreen.dart';
...
class AdminMenu extends StatelessWidget {
  ...
  void selectedItem(BuildContext context, int id) {
    ...
    switch (id) {
      ...
      case 4:
        Navigator.of(context).push(MaterialPageRoute(
            builder: (context) => EditRessourcesTypesScreen()),
        );
        break;
      case 5:
        Navigator.of(context).push(MaterialPageRoute(
      ...
      case 8:
        Navigator.of(context).push(MaterialPageRoute(
            builder: (context) => EditRessourcesGenresScreen()),
        );
        break;
      case 9:
        Navigator.of(context).push(MaterialPageRoute(
  ...
  Widget build(BuildContext context) {
    return ListView(
      ...
      children: <Widget>[
        ...
        buildMenuItem(
          text: "Editer les roles",
          icon: Icons.edit,
          onClicked: () => selectedItem(context, 7),
        ),
        buildMenuItem(
          text: "Editer les genres de ressource",
          icon: Icons.edit,
          onClicked: () => selectedItem(context, 8),
        ),
        buildMenuItem(
          text: "Editer les types de ressource",
          icon: Icons.assignment,
